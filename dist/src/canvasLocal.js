export class CanvasLocal {
    ...
    paint() {
        ...
        let colors = ['magenta', 'red', 'green', 'yellow', 'blue'];
        ...
        h.forEach((valor, ind) => {
            ...
            // EFECTO 3D (Tapas)
            let p = 0.3; // Factor de profundidad
            ...
            // 2. CARA SUPERIOR
            this.graphics.beginPath();
            this.graphics.moveTo(this.iX(0), this.iY(yPos + ancho));
            this.graphics.lineTo(this.iX(p), this.iY(yPos + ancho + p));
            this.graphics.lineTo(this.iX(largo + p), this.iY(yPos + ancho + p));
            this.graphics.lineTo(this.iX(largo), this.iY(yPos + ancho));
            this.graphics.closePath();
            this.graphics.fill();
